 ...
 * @version 1.0
 */
public class MKRR_u_i_hihi extends MO_MKRR {
	 ...
	 */
	public MKRR_u_i_hihi(Integer numberOfVariables, String solutionType,
	 ...
	 *            The solution type must "Int"
	 */
	public MKRR_u_i_hihi(String solutionType) {

		this(numberOfVariablesByDefault_, solutionType,
				numberOfIslandsByDefault_);
	} // u_i_hihi_mak_flow

	public MKRR_u_i_hihi(String solutionType, Integer instanceNumber) {
		this(numberOfVariablesByDefault_, solutionType,
				numberOfIslandsByDefault_);
	...
	public Problem clone() {
		MKRR_u_i_hihi newProblem = new MKRR_u_i_hihi("Int");
