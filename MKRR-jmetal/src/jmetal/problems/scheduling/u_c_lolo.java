...
/**
 * Class representing the problem u_c_lolo
 * 
 ...
 * @version 1.0
 */
public class u_c_lolo extends MO_Scheduling {
	...
	private static final String xmlMatrix_ = "u_c_lolo.0.xml";         ///< Filename where its stored the matrix
	private static final String path_      = "SchedInstances/basicETC/"; ///< Base directory of the matrices instances
	private static final String name_      = "u_c_lolo";               ///< Name of the problem
//	private static final double per_       = 0.3;                      ///< Constant used in the matrix
	 ...
	 */
	public u_c_lolo( Integer numberOfVariables, String solutionType, Integer numberOfIslands ) {
	 ...
	 * @param solutionType The solution type must "Int"
	 */
	public u_c_lolo( String solutionType ) {
	...
	public Problem clone() {
		u_c_lolo newProblem = new u_c_lolo( "Int" );
