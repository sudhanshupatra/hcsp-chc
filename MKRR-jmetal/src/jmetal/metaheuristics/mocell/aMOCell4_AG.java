 ...
 */
public class aMOCell4_AG extends Algorithm{

  //->fields
  private Problem problem_;          //The problem to solve        

  private int bisections_ = 5; // bisections for the adaptive grid 
  
  public aMOCell4_AG(Problem problem){
    problem_ = problem;
  }
  ...
  public SolutionSet execute() throws JMException {
    ...
    bisections_		  = ((Integer)getInputParameter("bisections")).intValue();
    ...
    archive            = new AdaptiveGridArchive(archiveSize,bisections_,problem_.getNumberOfObjectives());                
    evaluations        = 0;                        
