 ...
 */
public class aMOCell4_SRF extends Algorithm{

  //->fields
  private Problem problem_;          //The problem to solve         
  
  public aMOCell4_SRF(Problem problem){
    problem_ = problem;
  }
  ...
  public SolutionSet execute() throws JMException {
    ...
    StrengthRawFitnessArchive archive;
    ...
    archive            = new StrengthRawFitnessArchive(archiveSize);                
    evaluations        = 0;                        
