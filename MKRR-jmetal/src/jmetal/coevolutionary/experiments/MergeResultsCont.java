...
//import jmetal.coevolutionary.experiments.util.ExperimentNoPareto;
 ...
 * @version 1.0
 */
public class MergeResultsCont extends ExperimentNoPareto {
...
//	} // algorithmSettings
	...
	public static void main(String[] args) throws JMException, IOException, IllegalArgumentException {
		...
		MergeResultsCont standardStudy = new MergeResultsCont();
