...
/** 
 * This class represents a factory for <code>problems</code>
 *
...
public class SettingsFactory {
	...
	public Settings getSettingsObject( String algorithmName , Object[] params ) throws JMException {
		...
		String base = "jmetal.coevolutionary.experiments.settings." + algorithmName + "_Settings";
		...
		try {
			...
			"Please, check the algorithm name in jmetal/coevolutionary/metaheuristics") ;
