 ...
 * @version 1.0
 */
package jmetal.coevolutionary.experiments.util;
...
import jmetal.coevolutionary.experiments.SettingsFactory;
...
public class Main {
  ...
  public static void main(String [] args) throws 
    ...
    Islands islands   = new Islands( problem , algorithm );
    long initTime = System.currentTimeMillis();
    SolutionSet population = islands.execute();
