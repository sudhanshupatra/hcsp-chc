 ...
 */
public class MOCell_Settings_COR extends Settings{
...
//	private int    maxEvaluations_       = 500              ; ///< Number of evaluations
...
//	private static String P_SPECIAL_SOLUTION = "Min-min"           ; ///< Algorithm in order to setup the initial population
   ...
   * Constructor
   */
  public MOCell_Settings_COR(Problem problem) {
    super(problem) ;
  ...
  public Algorithm configure() throws JMException {
    ...
    algorithm = new aMOCell4Sched(problem_) ;
