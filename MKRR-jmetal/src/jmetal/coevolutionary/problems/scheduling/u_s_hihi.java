...
/**
 * Class representing the problem u_s_hihi
 * 
 ...
 * @version 1.0
 */
public class u_s_hihi extends MO_Scheduling {
	...
	private static final String xmlMatrix_ = "u_s_hihi.0.xml";         ///< Filename where its stored the matrix
	private static final String name_      = "u_s_hihi";               ///< Name of the problem
	 ...
	 */
	public u_s_hihi( Integer numberOfVariables, String solutionType, Integer numberOfIslands ) {
...
//		Comp_ = M_.getComputationMatrix();
	 ...
	 * @param solutionType The solution type must "Int"
	 */
	public u_s_hihi( String solutionType ) {
	...
	public Problem clone() {
		u_s_hihi newProblem = new u_s_hihi( "Int" );
