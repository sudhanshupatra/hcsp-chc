...
/**
 * Class representing the problem u_c_lohi
 * 
 ...
 * @version 1.0
 */
public class u_c_lohi extends MO_Scheduling {
	...
	private static final String xmlMatrix_ = "u_c_lohi.0.xml";         ///< Filename where its stored the matrix
	private static final String name_      = "u_c_lohi";               ///< Name of the problem
	 ...
	 */
	public u_c_lohi( Integer numberOfVariables, String solutionType, Integer numberOfIslands ) {
...
//		Comp_ = M_.getComputationMatrix();
	 ...
	 * @param solutionType The solution type must "Int"
	 */
	public u_c_lohi( String solutionType ) {
	...
	public Problem clone() {
		u_c_lohi newProblem = new u_c_lohi( "Int" );
