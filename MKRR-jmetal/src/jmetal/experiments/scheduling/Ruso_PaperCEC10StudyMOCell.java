 ...
 */
public class Ruso_PaperCEC10StudyMOCell extends ExperimentNoPareto {
	...
	// private int numberOfInstancesDF_ = 100; // Number of instances to solve
	// per problem
	...
	public synchronized void algorithmSettings(Problem problem,
		...
		try {
			...
			for (int i = 0; i < numberOfAlgorithms; i++) {
				...
				// parameters[i].setProperty("MUTATION_ROUNDS", "1"); // Estaba
				// a 16 !!!!!!!!!!!!
				parameters[i].setProperty("MUTATION_ROUNDS", "25"); // Estaba a
																	// 16
																	// !!!!!!!!!!!!
	...
	public static void main(String[] args) throws JMException, IOException {
		...
		Ruso_PaperCEC10StudyMOCell exp = new Ruso_PaperCEC10StudyMOCell(); // exp
																			// =
																			// experiment

		exp.experimentName_ = "Ruso_PaperCEC10StudyMOCell";
		...
		exp.problemList_ = new String[] { "scheduling.u_i_hihi_mak_flow" };
