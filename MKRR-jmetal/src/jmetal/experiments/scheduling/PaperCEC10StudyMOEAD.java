 ...
 */
public class PaperCEC10StudyMOEAD extends ExperimentNoPareto {
...
//      algorithm[0] = new IBEA_Settings_CEC10(problem).configure(parameters[0]);
  ...
  public static void main(String[] args) throws JMException, IOException {
    ...
    PaperCEC10StudyMOEAD exp = new PaperCEC10StudyMOEAD() ; // exp = experiment
    
    exp.experimentName_  = "PaperCEC10StudyMOEAD" ;
