 ...
 */
public class PaperCEC10StudyMOEAD_1minmin_lolo extends ExperimentNoPareto {
	...
	private int numberOfInstancesDF_ = 100; // Number of instances to solve per problem
...
//      algorithm[0] = new NSGAII_Settings_CEC10(problem).configure(parameters[0]);
//      algorithm[0] = new IBEA_Settings_CEC10(problem).configure(parameters[0]);
      algorithm[0] = new MOEAD_Settings_CEC10(problem).configure(parameters[0]);
  ...
  public static void main(String[] args) throws JMException, IOException {
    ...
    PaperCEC10StudyMOEAD_1minmin_lolo exp = new PaperCEC10StudyMOEAD_1minmin_lolo() ; // exp = experiment
    
    exp.experimentName_  = "PaperCEC10StudyMOEAD_1minmin_lolo" ;
	exp.timmingFileName_   = "TIMMINGS";
    
	exp.algorithmNameList_   = new String[] {"MOEADSched"} ;
...
//            "WFG7","WFG8","WFG9"};
    ...
    exp.problemList_ = new String[]{"scheduling.u_i_lolo"};
...
//            "DTLZ7.2D.pf"};
    ...
    exp.paretoFrontFile_ = new String[]{"u_i_lolo.pf"};
