 ...
 */
public class PaperCEC10Study_50ejecs extends ExperimentNoPareto {
...
//        parameters[i].setProperty("RECOMBINATION", "UniformCrossover");
  ...
  public static void main(String[] args) throws JMException, IOException {
    ...
    PaperCEC10Study_50ejecs exp = new PaperCEC10Study_50ejecs() ; // exp = experiment
    
    exp.experimentName_  = "PaperCEC10Study_50ejecs" ;
