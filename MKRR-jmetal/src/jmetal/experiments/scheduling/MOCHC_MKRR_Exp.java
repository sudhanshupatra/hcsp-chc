 ...
 */
public class MOCHC_MKRR_Exp extends ExperimentNoPareto {
...
//	private int numberOfInstancesDF_ = 1;
	...
	public static void main(String[] args) throws JMException, IOException {
		...
		MOCHC_MKRR_Exp exp = new MOCHC_MKRR_Exp();
		exp.experimentName_ = "MO_CHC_MKRR";
		exp.timmingFileName_ = "TIMMINGS";
		exp.algorithmNameList_ = new String[] { "MOCHC" };
		exp.problemList_ = new String[] { 
				"scheduling.MKRR_u_c_hihi", "scheduling.MKRR_u_c_lohi", "scheduling.MKRR_u_c_hilo",
				"scheduling.MKRR_u_c_lolo", "scheduling.MKRR_u_i_hihi", "scheduling.MKRR_u_i_lohi",
				"scheduling.MKRR_u_i_hilo", "scheduling.MKRR_u_i_lolo", "scheduling.MKRR_u_s_hihi",
				"scheduling.MKRR_u_s_lohi", "scheduling.MKRR_u_s_hilo", "scheduling.MKRR_u_s_lolo",
				};
