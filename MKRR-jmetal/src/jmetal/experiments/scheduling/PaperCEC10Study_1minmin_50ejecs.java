 ...
 */
public class PaperCEC10Study_1minmin_50ejecs extends ExperimentNoPareto {
  
	private int independentRunsDf_ = 50;   // Number of independent runs per algorithm and problem
	private int numberOfThreadsDf_ = 1;   // Number of threads to use (= number of algorithms to run in parallel)
	private int numberOfInstancesDF_ = 50; // Number of instances to solve per problem
...
//        parameters[i].setProperty("RECOMBINATION", "UniformCrossover");
  ...
  public static void main(String[] args) throws JMException, IOException {
    ...
    PaperCEC10Study_1minmin_50ejecs exp = new PaperCEC10Study_1minmin_50ejecs() ; // exp = experiment
    
    exp.experimentName_  = "PaperCEC10Study_1minmin_50ejecs" ;
