 ...
 */
public class MOCHC_MKRR_2k_Exp extends ExperimentNoPareto {
...
//	private int numberOfInstancesDF_ = 1;
	...
	public static void main(String[] args) throws JMException, IOException {
		...
		MOCHC_MKRR_2k_Exp exp = new MOCHC_MKRR_2k_Exp();
		exp.experimentName_ = "MO_CHC_MKRR_2k";
		exp.timmingFileName_ = "TIMMINGS";
		exp.algorithmNameList_ = new String[] { "MOCHC" };
		exp.problemList_ = new String[] { 
				"scheduling.MKRR_2k_A_u_c_hihi", "scheduling.MKRR_2k_A_u_c_lohi", "scheduling.MKRR_2k_A_u_c_hilo",
				"scheduling.MKRR_2k_A_u_c_lolo", "scheduling.MKRR_2k_A_u_i_hihi", "scheduling.MKRR_2k_A_u_i_lohi",
				"scheduling.MKRR_2k_A_u_i_hilo", "scheduling.MKRR_2k_A_u_i_lolo", "scheduling.MKRR_2k_A_u_s_hihi",
				"scheduling.MKRR_2k_A_u_s_lohi", "scheduling.MKRR_2k_A_u_s_hilo", "scheduling.MKRR_2k_A_u_s_lolo",
				"scheduling.MKRR_2k_B_u_c_hihi", "scheduling.MKRR_2k_B_u_c_lohi", "scheduling.MKRR_2k_B_u_c_hilo",
				"scheduling.MKRR_2k_B_u_c_lolo", "scheduling.MKRR_2k_B_u_i_hihi", "scheduling.MKRR_2k_B_u_i_lohi",
				"scheduling.MKRR_2k_B_u_i_hilo", "scheduling.MKRR_2k_B_u_i_lolo", "scheduling.MKRR_2k_B_u_s_hihi",
				"scheduling.MKRR_2k_B_u_s_lohi", "scheduling.MKRR_2k_B_u_s_hilo", "scheduling.MKRR_2k_B_u_s_lolo"
				};
