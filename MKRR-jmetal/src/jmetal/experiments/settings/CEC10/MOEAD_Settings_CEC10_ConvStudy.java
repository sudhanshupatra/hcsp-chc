 ...
 * @author Antonio
 */
public class MOEAD_Settings_CEC10_ConvStudy extends Settings {
	  // Default settings
...
//  double crossoverProbability_ = 0.9 ;
   ...
   * Constructor
   */
  public MOEAD_Settings_CEC10_ConvStudy(Problem problem) {
    super(problem);
  } // MOEAD_Settings
  ...
  public Algorithm configure() throws JMException {
	    ...
	    algorithm = new MOEADSchedConv(problem_) ;
