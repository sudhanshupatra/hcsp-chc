...
//	private MO_Scheduling_mak_flow problem_                   = null ; ///< The problem to solve
	private IMO_SchedulingProblem problem_                   = null ; ///< The problem to solve
	...
	private void doSimpleMutation( int[]             Schedule          , int start  , int end,
		...
		// Recover ETC Matrix
		double[][] ETC    = problem_.getETCMatrix();
	...
	public Object execute( Object object ) throws JMException {
		...
		if ( problem_ == null ) {
//			problem_ =  (MO_Scheduling_mak_flow) getParameter( "Problem" );
		...
		numberOfTasks_    = problem_.getNumberOfTasks()    ;
		numberOfMachines_ = problem_.getNumberOfMachines() ;
