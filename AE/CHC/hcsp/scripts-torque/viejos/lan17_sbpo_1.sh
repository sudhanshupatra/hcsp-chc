...
# Requerimientos
#PBS -l nodes=17,walltime=50:00:00
...
# Output path
#PBS -e /home/siturria/AE/trunk/AE/CHC/hcsp/ejecuciones/sbpo/1
#PBS -o /home/siturria/AE/trunk/AE/CHC/hcsp/ejecuciones/sbpo/1
...
do
	...
	BASE_FOLDER="/home/siturria/AE/trunk/AE/CHC/hcsp/ejecuciones/sbpo/1/${data[i]}"
	mkdir -p ${BASE_FOLDER}
