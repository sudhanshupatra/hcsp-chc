...
# Requerimientos
#PBS -l nodes=3,walltime=01:00:00

# Cola
#PBS -q publica

# Working dir
#PBS -d /home/siturria/AE/trunk/AE/CHC/hcsp/ejecuciones/temp
...
# Output path
#PBS -e /home/siturria/AE/trunk/AE/CHC/hcsp/ejecuciones/temp
#PBS -o /home/siturria/AE/trunk/AE/CHC/hcsp/ejecuciones/temp
...
do
	...
	BASE_FOLDER="/home/siturria/AE/trunk/AE/CHC/hcsp/ejecuciones/temp/${data[i]}"
	mkdir -p ${BASE_FOLDER}
