...
# Requerimientos
#PBS -l nodes=1:ppn=8:class0,walltime=00:30:00
...
# Output path
#PBS -e /home/siturria/AE/trunk/AE/CHC/hcsp/ejecuciones/prueba/gcc
#PBS -o /home/siturria/AE/trunk/AE/CHC/hcsp/ejecuciones/prueba/gcc
...
do
	...
	BASE_FOLDER="/home/siturria/AE/trunk/AE/CHC/hcsp/ejecuciones/prueba/gcc/${data[i]}"
	mkdir -p ${BASE_FOLDER}
