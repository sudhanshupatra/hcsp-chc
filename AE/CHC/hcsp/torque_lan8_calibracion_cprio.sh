...
# Nombre del trabajo
#PBS -N ae_lan8_cprio_cal

# Requerimientos
#PBS -l nodes=1:cpu8:ppn=8,walltime=250:00:00
...
# Output path
#PBS -e /home/siturria/AE/trunk/AE/CHC/hcsp/calibracion/lan8_cprio/
#PBS -o /home/siturria/AE/trunk/AE/CHC/hcsp/calibracion/lan8_cprio/
	...
	do
		...
		do
			...
			do
				...
				OutputFile="calibracion/lan8_cprio/${data[i]}_$CfgFile"
				
				echo "Datos $DataFile"
				
				echo "$CfgFile" > Config_LAN8.cfg
