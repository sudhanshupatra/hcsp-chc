...
# Requerimientos
#PBS -l nodes=2:class0:ppn=8,walltime=10:00:00
...
# Output path
#PBS -e /home/siturria/hcsp-chc/branches/AE-MF-Barca-2011/CHC/hcsp/ejecuciones/evaluacion/lan8+8a/
#PBS -o /home/siturria/hcsp-chc/branches/AE-MF-Barca-2011/CHC/hcsp/ejecuciones/evaluacion/lan8+8a/
...
EXEC="/home/siturria/bin/mpich2-1.2.1p1/bin/mpiexec.hydra -rmk pbs /home/siturria/hcsp-chc/branches/AE-MF-Barca-2011/CHC/hcsp/MainLan_x"
...
do
    ...
    do
    	...
    	do
    	    	...
    	    	OutputPath="${BASE_PATH}/ejecuciones/evaluacion/lan8+8a/${cfg[c]}/${data[i]}/${j}"
    	    	...
    	    	echo "${CfgFile}" > Config_lan8+8a_eval.cfg
    	    	echo "${DataFile}" >> Config_lan8+8a_eval.cfg
    	    	echo "${OutputPath}/${j}.sol" >> Config_lan8+8a_eval.cfg
    	    	echo "${PesosFile}" >> Config_lan8+8a_eval.cfg
                echo "${dim_tasks[c]}" >> Config_lan8+8a_eval.cfg
            	echo "${dim_machines[c]}" >> Config_lan8+8a_eval.cfg
        	
    	    	time($EXEC Config_lan8+8a_eval.cfg > ${OutputPath}/${j}.log) 
    	        echo "==============================================="
    	done
    done
done
