...
do
	...
	echo "${CfgFile}" > Config_LAN8_eval3.cfg
	echo "$DataFile" >> Config_LAN8_eval3.cfg
	echo "$OutputFile.sol" >> Config_LAN8_eval3.cfg
	
	time($EXEC Config_LAN8_eval3.cfg > $OutputFile.log) 
done