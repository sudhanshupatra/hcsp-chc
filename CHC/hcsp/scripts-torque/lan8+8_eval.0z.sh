...
# Requerimientos
#PBS -l nodes=2:class0:ppn=8,walltime=5:00:00
...
# Output path
#PBS -e /home/siturria/hcsp-chc/branches/AE-MF-Barca-2011/CHC/hcsp/ejecuciones/evaluacion/lan8+8z/
#PBS -o /home/siturria/hcsp-chc/branches/AE-MF-Barca-2011/CHC/hcsp/ejecuciones/evaluacion/lan8+8z/
...
do
    ...
    do
    	...
    	do
    	    	...
    	    	OutputPath="${BASE_PATH}/ejecuciones/evaluacion/lan8+8z/${cfg[c]}/${data[i]}/${j}"
    	    	...
    	    	echo "${CfgFile}" > Config_lan8+8z_eval.cfg
    	    	echo "${DataFile}" >> Config_lan8+8z_eval.cfg
    	    	echo "${OutputPath}/${j}.sol" >> Config_lan8+8z_eval.cfg
    	    	echo "${PesosFile}" >> Config_lan8+8z_eval.cfg
                echo "${dim_tasks[c]}" >> Config_lan8+8z_eval.cfg
            	echo "${dim_machines[c]}" >> Config_lan8+8z_eval.cfg
        	
    	    	time($EXEC Config_lan8+8z_eval.cfg > ${OutputPath}/${j}.log) 
    	        echo "==============================================="
    	done
    done
done
