...
# Output path
#PBS -e /home/siturria/AE/trunk/AE/CHC/hcsp/ejecuciones/sbpo/2
#PBS -o /home/siturria/AE/trunk/AE/CHC/hcsp/ejecuciones/sbpo/2
...
do
	...
	BASE_FOLDER="/home/siturria/AE/trunk/AE/CHC/hcsp/ejecuciones/sbpo/2/${data[i]}"
	mkdir -p ${BASE_FOLDER}
