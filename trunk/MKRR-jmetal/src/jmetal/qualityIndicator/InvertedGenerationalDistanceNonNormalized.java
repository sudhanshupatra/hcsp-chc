 ...
 *            Inst. Technol. (1998)
 */
public class InvertedGenerationalDistanceNonNormalized {
   ...
   */
  public InvertedGenerationalDistanceNonNormalized() {
...
//    		                                          minimumValue);
    ...
    for (int i = 0; i < trueParetoFront.length; i++) 
      sum += Math.pow(utils_.distanceToClosedPoint(trueParetoFront[i],
    		                                       front),
    		                                       pow_);
