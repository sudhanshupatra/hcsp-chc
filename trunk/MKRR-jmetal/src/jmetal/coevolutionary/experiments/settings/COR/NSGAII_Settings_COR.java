 ...
 */
public class NSGAII_Settings_COR extends Settings{
...
//  double crossoverProbability_ = 0.9 ;
  ...
  double  distributionIndexForCrossover_ = 20    ;
  	...
  	private String SELECTION             = "BinaryTournament2"  ; ///< Selection operator
...
//	private static String P_SPECIAL_SOLUTION = "Min-min"           ; ///< Algorithm in order to setup the initial population
   ...
   * Constructor
   */
  public NSGAII_Settings_COR(Problem problem) {
    super(problem) ;
  ...
  public Algorithm configure() throws JMException {
    ...
    algorithm = new NSGAIISched(problem_) ;
