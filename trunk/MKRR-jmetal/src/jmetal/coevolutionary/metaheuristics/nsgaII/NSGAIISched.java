 ...
 * @version 1.1
 */
public class NSGAIISched extends Algorithm {
	...
	private Operator localSearchOperator_ ; ///< local search operator
...
// REMARK Cuando postGeneration llama a prepare, podria aprovechar el ranking hecho anteriormente Àno?
	...
	public Algorithm clone() {
		NSGAIISched algorithmToReturn = new NSGAIISched( problem_ );
