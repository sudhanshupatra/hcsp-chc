...
/**
 * Class representing the problem u_i_lolo
 * 
 ...
 * @version 1.0
 */
public class u_i_lolo extends MO_Scheduling {
	...
	private static final String xmlMatrix_ = "u_i_lolo.0.xml";         ///< Filename where its stored the matrix
	private static final String name_      = "u_i_lolo";               ///< Name of the problem
	 ...
	 */
	public u_i_lolo( Integer numberOfVariables, String solutionType, Integer numberOfIslands ) {
...
//		Comp_ = M_.getComputationMatrix();
	 ...
	 * @param numberOfIslands Number of islands to use, must be greater than 1
	 */
	public u_i_lolo( Integer numberOfVariables, String solutionType, Integer numberOfIslands, Integer instanceNumber) {
...
//		Comp_ = M_.getComputationMatrix();
	 ...
	 * @param solutionType The solution type must "Int"
	 */
	public u_i_lolo( String solutionType ) {
	...
	public Problem clone() {
		u_i_lolo newProblem = new u_i_lolo( "Int" );
