...
/**
 * Class representing the problem u_s_lolo
 * 
 ...
 * @version 1.0
 */
public class u_s_lolo extends MO_Scheduling {
	...
	private static final String xmlMatrix_ = "u_s_lolo.0.xml";         ///< Filename where its stored the matrix
	private static final String name_      = "u_s_lolo";               ///< Name of the problem
	 ...
	 */
	public u_s_lolo( Integer numberOfVariables, String solutionType, Integer numberOfIslands ) {
...
//		Comp_ = M_.getComputationMatrix();
	 ...
	 * @param solutionType The solution type must "Int"
	 */
	public u_s_lolo( String solutionType ) {
	...
	public Problem clone() {
		u_s_lolo newProblem = new u_s_lolo( "Int" );
