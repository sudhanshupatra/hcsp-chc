...
/**
 * Class representing the problem u_c_hilo
 * 
 ...
 * @version 1.0
 */
public class u_s_hilo extends MO_Scheduling {
	...
	private static final String xmlMatrix_ = "u_s_hilo.0.xml";         ///< Filename where its stored the matrix
	private static final String name_      = "u_s_hilo";               ///< Name of the problem
	 ...
	 */
	public u_s_hilo( Integer numberOfVariables, String solutionType, Integer numberOfIslands ) {
...
//		Comp_ = M_.getComputationMatrix();
	 ...
	 * @param solutionType The solution type must "Int"
	 */
	public u_s_hilo( String solutionType ) {
	...
	public Problem clone() {
		u_s_hilo newProblem = new u_s_hilo( "Int" );
