 ...
 */
public class MOCell_Settings_CEC10_ConvStudy extends Settings{
...
//  double crossoverProbability_ = 0.9 ;
   ...
   * Constructor
   */
  public MOCell_Settings_CEC10_ConvStudy(Problem problem) {
    super(problem) ;
  } // MOCell_Settings
  ...
  public Algorithm configure() throws JMException {
    ...
    algorithm = new aMOCell4SchedConv(problem_) ;
