...
import jmetal.metaheuristics.ibea.IBEASchedConv;
 ...
 * @author Antonio J. Nebro
 */
public class IBEA_Settings_CEC10_ConvStudy extends Settings{
...
//  double crossoverProbability_ = 0.9 ;
   ...
   * Constructor
   */
  public IBEA_Settings_CEC10_ConvStudy(Problem problem) {
    super(problem) ;
  } // IBEA_Settings
  ...
  public Algorithm configure() throws JMException {
	    ...
	    algorithm = new IBEASchedConv(problem_) ;
