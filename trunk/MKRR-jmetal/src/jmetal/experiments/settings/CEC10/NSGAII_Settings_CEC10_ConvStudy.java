...
import jmetal.metaheuristics.mocell.aMOCell4Sched;
 ...
 * @author Antonio J. Nebro
 */
public class NSGAII_Settings_CEC10_ConvStudy extends Settings {
...
//  double crossoverProbability_ = 0.9 ;
   ...
   * Constructor
   */
  public NSGAII_Settings_CEC10_ConvStudy(Problem problem) {
    super(problem) ;
  } // NSGAII_Settings
  ...
  public Algorithm configure() throws JMException {
	    ...
	    algorithm = new NSGAIISchedConv(problem_) ;
