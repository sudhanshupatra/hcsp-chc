/**
 * aMOCell_SettingsCTBT.java
 *
 * @author Bernabe Dorronsoro
 * @version 1.0
 *
 * MOCell Settings class of algorithm aMOCell4 in which one of 
 *   the parents is forced to be the current individual itself
 */
 ...
 * @author Bernabe Dorronsoro
 */
public class sMOCellCTBT_Settings extends Settings{
   ...
   * Constructor
   */
  public sMOCellCTBT_Settings(Problem problem) {
    super(problem) ;
  } // MOCell_Settings
