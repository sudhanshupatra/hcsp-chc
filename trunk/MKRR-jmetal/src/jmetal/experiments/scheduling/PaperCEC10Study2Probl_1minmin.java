 ...
 */
public class PaperCEC10Study2Probl_1minmin extends ExperimentNoPareto {
...
//        parameters[i].setProperty("RECOMBINATION", "UniformCrossover");
  ...
  public static void main(String[] args) throws JMException, IOException {
    ...
    PaperCEC10Study2Probl_1minmin exp = new PaperCEC10Study2Probl_1minmin() ; // exp = experiment
    
    exp.experimentName_  = "PaperCEC10Study2Probl_1minmin" ;
