 ...
 */
public class PaperCEC10ConvergenceStudy extends ExperimentConvStudy {
...
//        parameters[i].setProperty("RECOMBINATION", "UniformCrossover");
  ...
  public static void main(String[] args) throws JMException, IOException {
    ...
    PaperCEC10ConvergenceStudy exp = new PaperCEC10ConvergenceStudy() ; // exp = experiment
    
    exp.experimentName_  = "PaperCEC10ConvergenceStudy" ;
