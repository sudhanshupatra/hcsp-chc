 ...
 */
public class PaperCEC10StudyNSGAII_lolo extends ExperimentNoPareto {
...
//      algorithm[3] = new MOEAD_Settings_CEC10(problem).configure(parameters[3]);
  ...
  public static void main(String[] args) throws JMException, IOException {
    ...
    PaperCEC10StudyNSGAII_lolo exp = new PaperCEC10StudyNSGAII_lolo() ; // exp = experiment
    
    exp.experimentName_  = "PaperCEC10StudyNSGAII_lolo" ;
