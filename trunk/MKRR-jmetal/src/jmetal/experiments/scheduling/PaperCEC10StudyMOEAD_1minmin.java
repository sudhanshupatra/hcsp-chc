 ...
 */
public class PaperCEC10StudyMOEAD_1minmin extends ExperimentNoPareto {
...
//      algorithm[0] = new IBEA_Settings_CEC10(problem).configure(parameters[0]);
  ...
  public static void main(String[] args) throws JMException, IOException {
    ...
    PaperCEC10StudyMOEAD_1minmin exp = new PaperCEC10StudyMOEAD_1minmin() ; // exp = experiment
    
    exp.experimentName_  = "PaperCEC10StudyMOEAD_1minmin" ;
