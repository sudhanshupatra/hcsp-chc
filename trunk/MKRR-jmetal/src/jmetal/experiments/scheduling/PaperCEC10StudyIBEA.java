 ...
 */
public class PaperCEC10StudyIBEA extends ExperimentNoPareto {
...
//      algorithm[3] = new MOEAD_Settings_CEC10(problem).configure(parameters[3]);
  ...
  public static void main(String[] args) throws JMException, IOException {
    ...
    PaperCEC10StudyIBEA exp = new PaperCEC10StudyIBEA() ; // exp = experiment
    
    exp.experimentName_  = "PaperCEC10StudyIBEA" ;
