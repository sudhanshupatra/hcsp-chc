 ...
 */
public class PaperCEC10StudyIBEA_1minmin_lolo extends ExperimentNoPareto {
...
//      algorithm[3] = new MOEAD_Settings_CEC10(problem).configure(parameters[3]);
  ...
  public static void main(String[] args) throws JMException, IOException {
    ...
    PaperCEC10StudyIBEA_1minmin_lolo exp = new PaperCEC10StudyIBEA_1minmin_lolo() ; // exp = experiment
    
    exp.experimentName_  = "PaperCEC10StudyIBEA_1minmin_lolo" ;
	exp.timmingFileName_   = "TIMMINGS";
    
	exp.algorithmNameList_   = new String[] {"IBEASched"} ;
