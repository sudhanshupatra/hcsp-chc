 ...
 */
public class MOCHC_MKRR_4k_Exp extends ExperimentNoPareto {
...
//	private int numberOfInstancesDF_ = 1;
	...
	public static void main(String[] args) throws JMException, IOException {
		...
		MOCHC_MKRR_4k_Exp exp = new MOCHC_MKRR_4k_Exp();
		exp.experimentName_ = "MO_CHC_MKRR_4k";
		exp.timmingFileName_ = "TIMMINGS";
		exp.algorithmNameList_ = new String[] { "MOCHC" };
		exp.problemList_ = new String[] { 
				"scheduling.MKRR_4k_A_u_c_hihi", "scheduling.MKRR_4k_A_u_c_lohi", "scheduling.MKRR_4k_A_u_c_hilo",
				"scheduling.MKRR_4k_A_u_c_lolo", "scheduling.MKRR_4k_A_u_i_hihi", "scheduling.MKRR_4k_A_u_i_lohi",
				"scheduling.MKRR_4k_A_u_i_hilo", "scheduling.MKRR_4k_A_u_i_lolo", "scheduling.MKRR_4k_A_u_s_hihi",
				"scheduling.MKRR_4k_A_u_s_lohi", "scheduling.MKRR_4k_A_u_s_hilo", "scheduling.MKRR_4k_A_u_s_lolo",
				"scheduling.MKRR_4k_B_u_c_hihi", "scheduling.MKRR_4k_B_u_c_lohi", "scheduling.MKRR_4k_B_u_c_hilo",
				"scheduling.MKRR_4k_B_u_c_lolo", "scheduling.MKRR_4k_B_u_i_hihi", "scheduling.MKRR_4k_B_u_i_lohi",
				"scheduling.MKRR_4k_B_u_i_hilo", "scheduling.MKRR_4k_B_u_i_lolo", "scheduling.MKRR_4k_B_u_s_hihi",
				"scheduling.MKRR_4k_B_u_s_lohi", "scheduling.MKRR_4k_B_u_s_hilo", "scheduling.MKRR_4k_B_u_s_lolo"
				};
