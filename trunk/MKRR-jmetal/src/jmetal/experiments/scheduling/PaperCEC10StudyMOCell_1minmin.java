 ...
 */
public class PaperCEC10StudyMOCell_1minmin extends ExperimentNoPareto {
...
//      algorithm[3] = new MOEAD_Settings_CEC10(problem).configure(parameters[3]);
  ...
  public static void main(String[] args) throws JMException, IOException {
    ...
    PaperCEC10StudyMOCell_1minmin exp = new PaperCEC10StudyMOCell_1minmin() ; // exp = experiment
    
    exp.experimentName_  = "PaperCEC10StudyMOCell_1minmin" ;
