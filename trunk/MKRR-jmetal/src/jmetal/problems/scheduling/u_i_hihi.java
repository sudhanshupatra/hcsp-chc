 ...
 * 
 * @author Juan A. Cañero Tamayo modified by Bernabé Dorronsoro
 * 
 * @version 1.0
 */
public class u_i_hihi extends MO_Scheduling {
...
//	private static final double per_       = 0.3;                      ///< Constant used in the matrix
	 ...
	 */
	public u_i_hihi( Integer numberOfVariables, String solutionType, Integer numberOfIslands ) {
	 ...
	 * @param solutionType The solution type must "Int"
	 */
	public u_i_hihi( String solutionType ) {

		this( numberOfVariablesByDefault_ , solutionType , numberOfIslandsByDefault_ );
	} // u_i_hihi

	public u_i_hihi( String solutionType, Integer instanceNumber) {
		this( numberOfVariablesByDefault_ , solutionType , numberOfIslandsByDefault_ );
...
//	}
	...
	public Problem clone() {
		u_i_hihi newProblem = new u_i_hihi( "Int" );
