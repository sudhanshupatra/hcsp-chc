...
/**
 * Class representing the problem u_i_lohi
 * 
 ...
 * @version 1.0
 */
public class u_i_lohi extends MO_Scheduling {
	...
	private static final String xmlMatrix_ = "u_i_lohi.0.xml";         ///< Filename where its stored the matrix
	private static final String path_      = "SchedInstances/basicETC/"; ///< Base directory of the matrices instances
	private static final String name_      = "u_i_lohi";               ///< Name of the problem
//	private static final double per_       = 0.3;                      ///< Constant used in the matrix
	 ...
	 */
	public u_i_lohi( Integer numberOfVariables, String solutionType, Integer numberOfIslands ) {
	 ...
	 * @param solutionType The solution type must "Int"
	 */
	public u_i_lohi( String solutionType ) {
	...
	public Problem clone() {
		u_i_lohi newProblem = new u_i_lohi( "Int" );
