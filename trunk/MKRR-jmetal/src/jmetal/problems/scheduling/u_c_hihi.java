 ...
 * @version 1.0
 */
public class u_c_hihi extends MO_Scheduling {
	
	private static final long serialVersionUID = 3635667271696598943L;

	private static final String xmlPath_   = "HCSP instances/512x16/"; ///< Base directory of the matrices instances
	private static final String xmlMatrix_ = "u_c_hihi.0.xml";         ///< Filename where its stored the matrix
	private static final String path_      = "SchedInstances/basicETC/"; ///< Base directory of the matrices instances
	private static final String name_      = "u_c_hihi";               ///< Name of the problem
//	private static final double per_       = 0.3;                      ///< Constant used in the matrix
	 ...
	 */
	public u_c_hihi( Integer numberOfVariables, String solutionType, Integer numberOfIslands ) {
...
//		Comp_ = M_.getComputationMatrix();
	 ...
	 * @param solutionType The solution type must "Int"
	 */
	public u_c_hihi( String solutionType ) {
	...
	public Problem clone() {
		u_c_hihi newProblem = new u_c_hihi( "Int" );

		// Commented by BernabŽ --- deprecated function?
