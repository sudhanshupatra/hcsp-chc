 ...
 * @version 1.0
 */
public class MKRR_2k_A_u_i_lolo extends MO_MKRR {
	 ...
	 */
	public MKRR_2k_A_u_i_lolo(Integer numberOfVariables, String solutionType,
...
//		M_.recoverData(512, 16, path_ + name_ + "." + instanceNo_);
	 ...
	 *            The solution type must "Int"
	 */
	public MKRR_2k_A_u_i_lolo(String solutionType) {

		this(numberOfVariablesByDefault_, solutionType,
				numberOfIslandsByDefault_);
	} // u_i_hihi_mak_flow

	public MKRR_2k_A_u_i_lolo(String solutionType, Integer instanceNumber) {
		this(numberOfVariablesByDefault_, solutionType,
				numberOfIslandsByDefault_);
	...
	public Problem clone() {
		MKRR_2k_A_u_i_lolo newProblem = new MKRR_2k_A_u_i_lolo("Int");
