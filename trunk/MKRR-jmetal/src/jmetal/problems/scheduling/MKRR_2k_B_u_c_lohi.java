 ...
 * @version 1.0
 */
public class MKRR_2k_B_u_c_lohi extends MO_MKRR {

	private static final long serialVersionUID = -2210887953365922092L;

	// Base directory of the matrices instances
	private static final String path_ = "./SchedInstances/WRRETC_2k/";
	private static final String name_ = "B.u_c_lohi"; // /< Name of the problem
	 ...
	 */
	public MKRR_2k_B_u_c_lohi(Integer numberOfVariables, String solutionType,
...
//		M_.recoverData(512, 16, path_ + name_ + "." + instanceNo_);
	 ...
	 *            The solution type must "Int"
	 */
	public MKRR_2k_B_u_c_lohi(String solutionType) {

		this(numberOfVariablesByDefault_, solutionType,
				numberOfIslandsByDefault_);
	} // u_i_hihi_mak_flow

	public MKRR_2k_B_u_c_lohi(String solutionType, Integer instanceNumber) {
		this(numberOfVariablesByDefault_, solutionType,
				numberOfIslandsByDefault_);
	...
	public Problem clone() {
		MKRR_2k_B_u_c_lohi newProblem = new MKRR_2k_B_u_c_lohi("Int");
