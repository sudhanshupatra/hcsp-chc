 ...
 * @version 1.0
 */
public class MKRR_1k_A_u_i_lohi extends MO_MKRR {
	 ...
	 */
	public MKRR_1k_A_u_i_lohi(Integer numberOfVariables, String solutionType,
...
//		M_.recoverData(512, 16, path_ + name_ + "." + instanceNo_);
	 ...
	 *            The solution type must "Int"
	 */
	public MKRR_1k_A_u_i_lohi(String solutionType) {

		this(numberOfVariablesByDefault_, solutionType,
				numberOfIslandsByDefault_);
	} // u_i_hihi_mak_flow

	public MKRR_1k_A_u_i_lohi(String solutionType, Integer instanceNumber) {
		this(numberOfVariablesByDefault_, solutionType,
				numberOfIslandsByDefault_);
	...
	public Problem clone() {
		MKRR_1k_A_u_i_lohi newProblem = new MKRR_1k_A_u_i_lohi("Int");
