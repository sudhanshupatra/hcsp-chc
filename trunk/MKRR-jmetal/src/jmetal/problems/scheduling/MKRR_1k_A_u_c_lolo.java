 ...
 * @version 1.0
 */
public class MKRR_1k_A_u_c_lolo extends MO_MKRR {
	...
	private static final String name_ = "A.u_c_lolo"; // /< Name of the problem
	 ...
	 */
	public MKRR_1k_A_u_c_lolo(Integer numberOfVariables, String solutionType,
...
//		M_.recoverData(512, 16, path_ + name_ + "." + instanceNo_);
	 ...
	 *            The solution type must "Int"
	 */
	public MKRR_1k_A_u_c_lolo(String solutionType) {

		this(numberOfVariablesByDefault_, solutionType,
				numberOfIslandsByDefault_);
	} // u_i_hihi_mak_flow

	public MKRR_1k_A_u_c_lolo(String solutionType, Integer instanceNumber) {
		this(numberOfVariablesByDefault_, solutionType,
				numberOfIslandsByDefault_);
	...
	public Problem clone() {
		MKRR_1k_A_u_c_lolo newProblem = new MKRR_1k_A_u_c_lolo("Int");
