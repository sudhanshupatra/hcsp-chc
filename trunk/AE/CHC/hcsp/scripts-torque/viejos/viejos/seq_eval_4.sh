...
# Output path
#PBS -e /home/siturria/AE/trunk/AE/CHC/hcsp/ejecuciones/evaluacion/seq/
#PBS -o /home/siturria/AE/trunk/AE/CHC/hcsp/ejecuciones/evaluacion/seq/
...
do
	...
	OutputFile="/home/siturria/AE/trunk/AE/CHC/hcsp/ejecuciones/evaluacion/seq/4096x128/${data[i]}"
	
	echo "Datos $DataFile"
	
	time(/home/siturria/AE/trunk/AE/CHC/hcsp/MainSeq $CfgFile $DataFile $OutputFile.sol > $OutputFile.log)    
done
