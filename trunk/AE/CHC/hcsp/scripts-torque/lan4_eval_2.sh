...
do
	...
	echo "CHC_LAN4.cfg" > Config_LAN4_eval2.cfg
	echo "$DataFile" >> Config_LAN4_eval2.cfg
	echo "$OutputFile.sol" >> Config_LAN4_eval2.cfg
	
	time($EXEC Config_LAN4_eval2.cfg > $OutputFile.log) 
done
